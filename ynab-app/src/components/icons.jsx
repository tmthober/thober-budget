// Ícones inline (sem depender de nenhuma lib externa ou webfont).
// stroke-based, 24x24, seguindo o mesmo estilo visual entre eles.

export function IconBudget({ size = 24 }) {
  return (
...
export function IconPieChart({ size = 24 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
export function IconAssistant({ size = 24 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
